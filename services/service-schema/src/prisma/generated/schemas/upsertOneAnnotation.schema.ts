...
export const AnnotationUpsertSchema = z.object({
  ...
  create: z.union([
    AnnotationCreateInputObjectSchema,
    AnnotationUncheckedCreateInputObjectSchema,
  ]),
  update: z.union([
    AnnotationUpdateInputObjectSchema,
    AnnotationUncheckedUpdateInputObjectSchema,
  ]),
});
